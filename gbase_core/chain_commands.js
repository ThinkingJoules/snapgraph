...
const makenewRow = checkUniqueAlias => path => (alias, data)=>{//HANDLE NEW PUT HERE, MOVE FROM EDIT
...
const linkRowTo = (path) => (rowLinkCol, gbaseGetRow)=>{//needs to be converted to new api
