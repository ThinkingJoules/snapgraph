...
const snap = Snap(['http://localhost:8765/snap'],{web: config.server.listen(config.port),dir:__dirname.split('/').slice(0,-1).join('/')+'/DATA',debug:console.log})//should put data in DATA folder in main repo area?
